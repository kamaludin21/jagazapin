@php
    use Carbon\Carbon;
    $data = App\Models\Dpo::show()->where('slug', $slug)->first();
    if (!$data):
        $page = env('APP_URL') . '/';
    else:
            ...
            <div class="col-12 col-md-9">
                <div class="mb-5 px-5">
                    ...
                    @else
                        ...
                        <h1>
                            <a wire:navigate.hover href="/dpo/{{ $data->slug }}"
                        ...
                        <img src="{{ $data->file ? asset('storage/' . $data->file) : asset('image/default-user.svg') }}"
